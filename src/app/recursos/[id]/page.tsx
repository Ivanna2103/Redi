      ...
      <div className="max-w-6xl mx-auto p-6 md:p-12">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-16">
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className={`relative aspect-square w-full ${esFuente ? 'max-w-[450px]' : 'max-w-[550px]'} rounded-2xl overflow-hidden shadow-2xl bg-white dark:bg-redi-vino/40 border border-redi-vino/10 dark:border-redi-beige/10 group`}>
              <Image
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              {(recurso.dimensiones && recurso.dimensiones.toLowerCase() !== 'variable') && (
                <div className="bg-white/50 dark:bg-redi-vino/40 px-6 py-4 rounded-3xl border border-redi-vino/10 dark:border-redi-beige/10 shadow-sm min-w-[160px]">
            ...
            <div className="space-y-4">
              {user ? (
                <button
                  ...
                  className={`w-full bg-white/50 dark:bg-redi-vino/40 text-redi-vino dark:text-redi-beige border border-redi-vino/10 dark:border-redi-beige/10 shadow-sm h-16 rounded-3xl font-bold flex items-center justify-center gap-3 transition-all active:scale-95 group ${!(recurso.url_archivo || recurso.archivo_url) ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105 hover:bg-white/80 dark:hover:bg-redi-vino/60'}`}
                >
                ...
                <Link
                  href="/auth/login"
                  className="w-full bg-white/50 dark:bg-redi-vino/40 text-redi-vino dark:text-redi-beige border border-redi-vino/10 dark:border-redi-beige/10 shadow-sm h-16 rounded-3xl font-bold flex items-center justify-center gap-3 transition-all active:scale-95 group hover:scale-105 hover:bg-white/80 dark:hover:bg-redi-vino/60"
                >
                  <Download className="w-5 h-5 transition-transform group-hover:translate-y-1 text-redi-vino/50 dark:text-redi-beige/50" />
                  DESCARGAR
                </Link>
              )}
              <p className="text-[10px] text-center text-redi-vino/50 dark:text-redi-beige/50 font-medium">
        ...
        {esFuente && (
          <div className="mt-10 border-t border-redi-vino/10 dark:border-redi-beige/10 pt-10">
            <FontPreview 
